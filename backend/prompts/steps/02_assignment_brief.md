...
---BRIEF START---
ARTICLE TITLE: [exact H1 — specific, benefit-led, not clickbait. Must contain primary keyword.]
ALTERNATIVE TITLES:
  1. [option — different angle, same keyword]
  2. [option — different framing, e.g. question format]
...
META DESCRIPTION: [150–160 characters exactly. Includes primary keyword. Ends with a specific reason to click, not a generic "learn more."]
...
TONE: [describe the voice in 2–3 adjectives + one example sentence that captures it perfectly]
